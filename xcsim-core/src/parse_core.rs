...
xcsim_core_l10n::tl_file!("parser" ptl);

#[path = "parse_core/extra_parse.rs"] mod extra;
pub use extra::parse_extra;

#[path = "parse_core/pec_parse.rs"] mod pec;
pub use pec::parse_pec;

#[path = "parse_core/pgr_parse.rs"] mod pgr;
pub use pgr::parse_phigros;

#[path = "parse_core/rpe_parse.rs"] mod rpe;
