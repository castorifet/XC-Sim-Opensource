use xcsim_core::core::{easing_from, StaticTween, TweenFunction, Tweenable};
use std::rc::Rc;
...
impl<T: Tweenable> Anim<T> {
    pub fn new(init: T) -> Self {
        Self {
            ...
            end_time: 1e-3,
            interpolator: StaticTween::get_rc(easing_from(xcsim_core::core::TweenMajor::Cubic, xcsim_core::core::TweenMinor::Out)),
        }
    }
